...
import { AddToolProps, EasyLLMProps, FunctionAny, LLMToolSchema, OtherProps, Callbacks, OnErrorCallback, OnResponseCallCallback, OnToolCallCallback, SendProps } from "../../types";
import { SendRequest, toolRegister } from "./utils";

export function EasyLLM({ url = 'https://api.deepseek.com/chat/completions', apiKey }: EasyLLMProps) {
